...
function AuthorDetail() {
    ...
    const authors = [
        ...
        { id: 7, name: 'Thomas Edison', bio: 'Thomas Edison was an American inventor and businessman who has been described as America\'s greatest inventor. He developed many devices in fields such as electric power generation, mass communication, sound recording, and motion pictures.', image: '/images/thomas_edison_img.webp' },
        { id: 8, name: 'Alan Turing', bio: 'Alan Turing was an English mathematician, computer scientist, logician, cryptanalyst, philosopher, and theoretical biologist. He was highly influential in the development of theoretical computer science, providing a formalisation of the concepts of algorithm and computation with the Turing machine, which can be considered a model of a general-purpose computer.', image: '/images/alan_turing_img.webp' },
        { id: 9, name: 'Dalai Lama', bio: 'The 14th Dalai Lama is the current Dalai Lama. Dalai Lamas are important monks of the Gelug school, the newest school of Tibetan Buddhism, which was formally headed by the Ganden Tripas.', image: '/images/dalai_lama_img.webp' },
        { id: 10, name: 'Abraham Lincoln', bio: 'Abraham Lincoln was an American statesman and lawyer who served as the 16th president of the United States from 1861 until his assassination in 1865. Lincoln led the nation through the American Civil War, the country\'s greatest moral, cultural, constitutional, and political crisis.', image: '/images/abraham_lincoln_img.webp' }
    ];
